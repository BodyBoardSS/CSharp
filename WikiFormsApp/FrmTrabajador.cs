...
namespace WikiFormsApp
{
    public partial class FrmTrabajador : Form
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (this.IsNuevo)
                    {
                        ...
                        this.txtApellidos.Text.Trim().ToUpper(), "Femenino".Equals(cbSexo.Text) ? "F" : "M",
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.cbSexo.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["sexo"].Value).Equals("F")? "Femenino" : "Masculino";
